...
import { loadNowContent, saveNowContent, type NowContent } from "@/lib/page-content";

export const prerender = false;

export const GET: APIRoute = async () => {
  try {
    const content = await loadNowContent();
...
export const PUT: APIRoute = async ({ request }) => {
  ...
  try {
    await saveNowContent(body.content);
